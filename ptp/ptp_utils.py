...
def register_attention_control(model, controller):
    def ca_forward(self, place_in_unet):
        ...
        def forward(x, context=None, mask=None, encoder_hidden_states=None, attention_mask=None):
            ...
            k = self.to_k(context)
            v = self.to_v(context)
            q = reshape_heads_to_batch_dim(self.heads, q)
            k = reshape_heads_to_batch_dim(self.heads, k)
            v = reshape_heads_to_batch_dim(self.heads, v)
            ...
            out = reshape_batch_dim_to_heads(self.heads, out)
            return to_out(out)
