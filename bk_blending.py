# Blends real images by interpolating frames from the real frames inward, one step at a time
# Interpolated frames look like noisy versions of the original near the ends,
# and don't look like anything meaningful in the middle
